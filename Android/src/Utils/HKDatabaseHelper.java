...
public class HKDatabaseHelper extends SQLiteOpenHelper{
	...
	public final static String COLUMN_REQUEST_USER_ID="user_id";
	...
	public HKDatabaseHelper(Context context) {
	...
	@Override
	  public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
	    Log.w(HKDatabaseHelper.class.getName(),
